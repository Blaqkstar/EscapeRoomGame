...
public class Phonograph extends Item{
    ...
    public void use() {
        if (!this.isUsed()) {
            ...
            // eerie effects
            System.out.println(ConsoleColors.GREEN+"PERCEPTION"+ConsoleColors.RESET+
                    ": Shadows in the room seem to lengthen and twist, their shapes forming patterns that make your head feel distant. The hum in the air rises to a deafening crescendo, and for a moment, you think you\n" +
            ...
            // abrupt end
            System.out.println(ConsoleColors.GREEN+"PERCEPTION"+ConsoleColors.RESET+
                    ": The music stops abruptly, the needle lifting from the record with a sharp click. The glow fades, and the room falls silent, save for the faint hum that lingers in the air. The shadows return to their normal shapes,\n" +
